...
export class aggridController implements Controller {
    ...
    private initializeRoutes() {
        this.router.delete('/aggrid/:id', this.GpDelete);
this.router.get('/aggrid/get/search', this.GpSearch);
this.router.put('/aggrid/get/update', this.GpSearchForUpdate);
this.router.put('/aggrid', this.GpUpdate);
this.router.get('/aggrid/:id', this.GpGetNounById);
this.router.get('/aggrid', this.GpGetAllValues);
this.router.post('/aggrid', this.GpCreate);
this.router.get('/aggrid/userid/created_by', this.GpGetNounCreatedBy);
        //#@gepdelimeterone@#
        //#@ssofacebookapiroute@#
        //#@ssogithubapiroute@#
    }
...
public GpDelete(req: Request, res: Response) {
        ...
        new ApiAdapter().delete(Constant.APPAGGRIDURL + `${req.url}` )
...
public GpSearch(req: Request, res: Response) {
        ...
        new ApiAdapter().get(Constant.APPAGGRIDURL + `${req.url}` )
        .then((res: any) => res.response.json()).then(result => {
            switch(req.baseUrl) { case '/mobile': res.send(result); break; case '/web': res.send(result); break; default: res.send(null); }
...
public GpSearchForUpdate(req: Request, res: Response) {
        ...
        new ApiAdapter().put(Constant.APPAGGRIDURL + `${req.url}` , req.body)
        .then((res: any) => res.response.json()).then(result => {
            switch(req.baseUrl) { case '/mobile': res.send(result); break; case '/web': res.send(result); break; default: res.send(null); }
...
public GpCreate(req: Request, res: Response) {
        ...
        new ApiAdapter().post(Constant.APPAGGRIDURL + `${req.url}` , req.body)
        .then((res: any) => res.response.json()).then(result => {
            switch(req.baseUrl) { case '/mobile': res.send(result); break; case '/web': res.send(result); break; default: res.send(null); }
